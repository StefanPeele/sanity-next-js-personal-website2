...
| **6.2 One annotation system** | `PENDING62` | **28/28** — glossary match renders as a margin note, labelled Definition, linked | self | `GlossaryTerm` deleted. The two sources differ by a label and a colour, not by a mechanism |
