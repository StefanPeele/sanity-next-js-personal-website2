...
| **5.1 Toolbar on the index + density** | `PENDING51` | rendered check: Theme/Text size/**Density**/Spacing/Accessibility, gap 32→20px | self | Same component, `variant="index"`. Width, Share, Read aloud and Your place correctly absent |
