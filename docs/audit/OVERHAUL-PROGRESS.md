...
| **3B Corrections in place** | `PENDING3B` | **27/27** — `measure-corrections.mjs`, draft mode, plus 13 transform unit tests | self | Passage marked in place with credit, permanent list at the foot, **three words not one** (correction / clarification / update). A broken anchor says so instead of vanishing |
