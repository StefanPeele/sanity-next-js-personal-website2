...
- [ ] **Full Playwright suite, 34 tests.** (33 before Phase 0.1 added the reading-time
      agreement test.) **If it reports any other number, investigate — do not re-run until
