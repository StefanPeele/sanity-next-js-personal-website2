  ...
  fields: [
    ...
    defineField({ name: 'footer', title: 'Footer', type: 'object', group: 'footer', initialValue: DEFAULT_SETTINGS.footer, fields: [
      ...
      defineField({ name: 'networkLabels', title: 'Link labels', type: 'object', fields: [
        ...
        defineField({ group: 'links', name: 'gitbook', title: 'Gitbook', type: 'string' }),
        defineField({ group: 'links', name: 'instagram', title: 'Instagram', type: 'string' }),
        defineField({ group: 'links', name: 'bluesky', title: 'Bluesky', type: 'string' }),
