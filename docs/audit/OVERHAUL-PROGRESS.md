...
| **7.1 The measure, measured** | `PENDING71` | n/a — proposal with frames | self, `measure-prose-width.mjs` | Current is **57.2 CPL**, confirming the amendment. **No fixed width works** across the seven reader text sizes; `ch` on a sized container holds CPL constant. Proposed 51/56/64ch |
