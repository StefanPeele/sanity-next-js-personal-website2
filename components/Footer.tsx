    ...
    <footer className="print:hidden h-card w-full bg-[#0a0a0a] border-t border-white/5 pt-20 pb-12 px-6 md:px-12 lg:px-20">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="pt-8 text-stone-400 font-sans text-sm">
          © {year}{' '}
          <a href={SITE.url} className={`p-name u-url inline-block py-1 text-stone-200 underline underline-offset-4 decoration-stone-600 hover:text-white hover:decoration-white rounded-sm ${FOCUS}`} rel="me">{settings.siteName}</a>.{' '}
