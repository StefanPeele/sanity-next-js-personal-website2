...
| **6.5 Learn more** | `PENDING65` | **30/30** — disabled path measured; enabled path **UNVERIFIABLE** here (no API key) | self | Returns titles and authors to look up, never hyperlinks. Generated on demand, never stored |
