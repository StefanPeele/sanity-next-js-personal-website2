...
| **6.3/6.4/6.5 Sidenotes in the margin** | `PENDING63` | **22/22** — `measure-sidenotes-margin.mjs` | self, + both mobile options captured | Notes travel with their anchors, never overlap, clamp with a "more" window that is focus-trapped. The TOC yields where they collide — and, measured, does **not** yield everywhere |
