...
// Source: sanity/lib/queries.ts
// Variable: feedQuery
// Query: *[_type == "post" && defined(slug.current) && defined(publishedAt)] | order(publishedAt desc)[0...50] {    _id, title, "slug": slug.current, publishedAt, _updatedAt, excerpt, body, articleType,    reviewStatus,    "lastRevised": (changelog[] | order(date desc)[0].date),    "categories": categories[]->title,    "imageUrl": mainImage.asset->url  }
