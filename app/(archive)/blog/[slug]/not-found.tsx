  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-stone-300 flex flex-col items-center justify-center px-6">
      ...
      <div className="max-w-lg w-full text-center">
        ...
        <span className="font-mono text-[10px] uppercase tracking-[0.4em] text-stone-500 block mb-8 border-l border-stone-700 pl-4 text-left">
        ...
        <p className="font-mono text-[10px] text-stone-500 uppercase tracking-widest mb-12">
