...
export default defineType({
  ...
  fields: [
    ...
    obj('readerMenu', 'Reading options menu', [
      ...
      obj('a11yLabels', 'Accessibility toggles', ['dyslexia', 'highContrast', 'reducedMotion', 'ruler', 'reset', 'linkUnderline', 'bigFocus', 'muteColour'].map((n) => str(n))),
    ...
    obj('comments', 'Comments', [
      ...
      str('bodyPlaceholder', 'Comment placeholder'),
      str('submitLabel', 'Submit'), str('submittingLabel', 'Submitting'),
      str('replyLabel', 'Reply'), str('cancelLabel', 'Cancel'),
      str('allLabel', 'All filter'), str('moreLabel', 'Show more'),
