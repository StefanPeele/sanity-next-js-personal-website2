  ...
  return (
    <figure className="rounded-xl border border-white/[0.08] bg-white/[0.02] p-4 overflow-hidden">
      <figcaption className="flex items-center justify-between gap-4 mb-3">
        <span className="font-mono text-[9px] uppercase tracking-[0.4em] text-stone-500 border-l-2 border-stone-700 pl-3">
          Growth timeline
        </span>
      ...
      {/* Text alternative */}
      <p className="mt-3 font-mono text-[9px] uppercase tracking-widest text-stone-500">
