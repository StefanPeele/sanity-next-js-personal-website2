    ...
    <div className="relative shrink-0" data-print-hide>
      ...
      {open && (
        <div
          ...
          className="absolute right-0 top-full mt-2 w-80 max-h-[70vh] overflow-y-auto z-[1002] rounded-xl border border-white/10 bg-[#111] shadow-2xl p-4 text-stone-200"
        >
